                    ...
                    <div class="header__actions"><a href="#">Login & Regiser</a>
                        <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#"><img
                                            src="{{ asset('web/website') }}/images/flag/usa.svg"
                                            alt=""> USD</a></li>
                                <li><a href="#"><img
                                            src="{{ asset('web/website') }}/images/flag/singapore.svg"
                                            alt=""> SGD</a></li>
                                <li><a href="#"><img
                                            src="{{ asset('web/website') }}/images/flag/japan.svg"
                                            alt=""> JPN</a></li>
                            </ul>
                        </div>
                        <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown"
        ...
        <div class="container-fluid">
            <div class="navigation__column left">
                <div class="header__logo"><a class="ps-logo" href="index.html"><img
                            src="{{ asset('web/website') }}/images/logo.png" alt=""></a></div>
            </div>
